...
public class DummyUserDao {
	...
	static {
		...
		AvatarPlayer marioUser = new AvatarPlayer(marioUn, marioUa, "just another user " + RandomStringUtils.random(5));
		...
		AvatarPlayer luigiUser = new AvatarPlayer(luigiUn, luigiUa, "just another user " + RandomStringUtils.random(5));
		...
		AvatarPlayer princessPeachUser = new AvatarPlayer(princessPeachUn, princessPeachUa, "just another user " + RandomStringUtils.random(5));
		...
		AvatarPlayer warioUser = new AvatarPlayer(warioUn, warioUa, "just another user " + RandomStringUtils.random(5));
